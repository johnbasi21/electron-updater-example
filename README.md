...
- [Complete electron-updater HTTP example](https://gist.github.com/johnbasi21/0ff845e8e3f59dbe7eaf2bf24443f104)
...
**NOTE:** If you want to run through this whole process, either fork this repo or [start your own from a template](https://github.com/johnbasi21/electron-updater-example/generate). Then replace all instances of `johnbasi21` with your GitHub username before doing the following steps.
